...
public class main {
    ...
    public static void main(String[] args) {
        ...
        if (snacks == 'y') {
            System.out.println("here are the snack types");
            //display snacks 
            System.out.println("please pick which snacks you would like along with the size of the snack");
            String snacktype = in.nextLine();
            System.out.println("Good choice! please pick which seats you would like");
        } else {
            System.out.println("please pick which seats you would like");
